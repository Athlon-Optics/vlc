...
vlc_module_begin ()
    ...
    add_submodule ()
        ...
        add_bool( "rtsp-live-timestamps", false,
                  LIVE_TIMESTAMPS_TEXT, LIVE_TIMESTAMPS_LONGTEXT, true )
            change_safe()
        add_integer( "rtsp-live-gap-timeout", DEFAULT_LIVE_GAP_TIMEOUT,
                     LIVE_GAP_TIMEOUT_TEXT, LIVE_GAP_TIMEOUT_LONGTEXT, true )
                        ...
                        unsigned int duration )
{
    ...
    const vlc_tick_t i_raw_pts = (int64_t)pts.tv_sec * INT64_C(1000000) +
                                 (int64_t)pts.tv_usec;
